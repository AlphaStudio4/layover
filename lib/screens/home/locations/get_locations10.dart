...
enum GeofenceEvented9 { init, enter, exit }
...
class Geofenced9 {
  ...
  static Stream<GeofenceEvented9>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented9> _controller =
      StreamController<GeofenceEvented9>();
  ...
  static Stream<GeofenceEvented9>? getGeofenceStreamed9() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented9.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented9.enter);
    } else {
      _controller.add(GeofenceEvented9.exit);
    }
  }
